...
/** @constructor */
function $c_Lwebapp_TutorialApp$() {
  $c_O.call(this)
}
$c_Lwebapp_TutorialApp$.prototype = new $h_O();
$c_Lwebapp_TutorialApp$.prototype.constructor = $c_Lwebapp_TutorialApp$;
/** @constructor */
function $h_Lwebapp_TutorialApp$() {
  /*<skip>*/
}
$h_Lwebapp_TutorialApp$.prototype = $c_Lwebapp_TutorialApp$.prototype;
$c_Lwebapp_TutorialApp$.prototype.init___ = (function() {
  $n_Lwebapp_TutorialApp$ = this;
  return this
});
$c_Lwebapp_TutorialApp$.prototype.main__V = (function() {
...
$c_Lwebapp_TutorialApp$.prototype.addClickedMessage__V = (function() {
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V($g["document"]["body"], "You clicked thr button!")
});
$c_Lwebapp_TutorialApp$.prototype.$$js$exported$meth$addClickedMessage__O = (function() {
  this.addClickedMessage__V()
});
$c_Lwebapp_TutorialApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lwebapp_TutorialApp$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = $g["document"]["createElement"]("p");
  var textNode = $g["document"]["createTextNode"](text);
  parNode["appendChild"](textNode);
  targetNode["appendChild"](parNode)
});
$c_Lwebapp_TutorialApp$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
$c_Lwebapp_TutorialApp$.prototype["addClickedMessage"] = (function() {
  return this.$$js$exported$meth$addClickedMessage__O()
});
var $d_Lwebapp_TutorialApp$ = new $TypeData().initClass({
  Lwebapp_TutorialApp$: 0
}, false, "webapp.TutorialApp$", {
  Lwebapp_TutorialApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lwebapp_TutorialApp$.prototype.$classData = $d_Lwebapp_TutorialApp$;
var $n_Lwebapp_TutorialApp$ = (void 0);
function $m_Lwebapp_TutorialApp$() {
  if ((!$n_Lwebapp_TutorialApp$)) {
    $n_Lwebapp_TutorialApp$ = new $c_Lwebapp_TutorialApp$().init___()
  };
  return $n_Lwebapp_TutorialApp$
}
$e["webapp"] = ($e["webapp"] || {});
$e["webapp"]["TutorialApp"] = $m_Lwebapp_TutorialApp$;
